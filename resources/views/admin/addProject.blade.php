            ...
            <form role="form" action="{{route('projectStore')}}" method="Post">
                ...
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <input type="text" name="title" class="name mb-5" placeholder="Enter Title"
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <label class="mb-2">Employees</label><br>
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        ...
                        <textarea type="text" name="description" cols="20" rows="5" placeholder="Enter Description "

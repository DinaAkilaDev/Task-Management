<div class="container">
    <div class="d-flex justify-content-between">
        ...
        <button class="mt-3 btn btn-success  mx-4 mb-3"><a href="{{route('projectCreate')}}"
                ...
                <div class="card d-flex"
                    ...
                    <div class="card-body">
                        <div style="padding: 20px;">
                            <h4 class="mb-3">{{$project->title}} <span class="m-lg-3"
                        ...
                        <div class="mx-4 mb-4 ">
                            ...
                            <div class="d-flex ">
                                <img width="50" height="50" src="{{'/storage/'. $project->Teamleader->User->photo}}"

        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    ...
                    <input type="text" name="name" value="{{$employee->name}}" class="name mb-5" placeholder="Name" style="width:70%; padding: 10px;">
                    <input type="hidden" name="id" value="{{$employee->id}}">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <label class="mb-2">Email</label><br>
                    <input type="Email" name="email" class="Email mb-5" value="{{$employee->User->email}}" placeholder="Email" style="width:70% ;padding: 10px;">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <label class="mb-3">mobile</label><br>
                    <input type="text" name="mobile" class="mobile mb-5" value="{{$employee->mobile}}" placeholder="mobile" style="width:70% ;padding: 10px;">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <label class="mb-2">Password</label><br>
                    <input type="Password" name="password" class="Password mb-5"  placeholder="Password" style="width:70% ; padding: 10px;">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <label class="mb-2">Job Name</label><br>
                    <input type="text" name="job_name" class="Job mb-5" value="{{$employee->job_name}}" placeholder="Job Name" style="width:70% ;padding: 10px;">
                </div>
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
